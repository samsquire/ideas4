...
Can define an algebra that works with nested collections and has a primitivd called associate which associates data of a source collection with another structure.
