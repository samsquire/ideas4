...
I propose a cas sort algorithm to maintain order between an arbitrary number of readers and writers. [I implemented this in my compare and swap sort repo.](HTTPS://GitHub.com/samsquire/compare-and-swap-sort)
